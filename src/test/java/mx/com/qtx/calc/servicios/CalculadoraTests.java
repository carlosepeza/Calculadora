...
class CalculadoraTests {
	...
	void testSumar_dobles() {
		...
		//Entonces -> Probar el resultado obtenido vs resultado esperado
		assertEquals(150.00000002, suma, 0.00000000000001, "El valor esperado no coincide con el obtenido");
	}
	...
	void testDividir() {
		...
		//Entonces
		assertEquals(50, resultado, 0.0000001, "No coinciden los valore esperado y obtenido");;
